...
ISSUES:
- trying to get gpu to work in container as thats the only way to get the sensor stuff to work otherwise i get opengl issues
   - could be because of ogre2 renderer use ogre1 instead?
